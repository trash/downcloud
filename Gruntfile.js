// Generated on 2014-09-13 using generator-angular-fullstack 1.4.3
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        compass: {
            ...
            dist: {
                options: {
                    generatedImagesDir:
                        '<%= yeoman.dist %>/public/images/generated',
                },
            },
            server: {
                options: {
    ...
    grunt.registerTask('heroku', function () {
        grunt.log.warn(
            'The `heroku` task has been deprecated. Use `grunt build` to build for deployment.'
        );
